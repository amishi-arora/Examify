...
export default function ExamPage({ studentAnswers, examQuestions, setExamAnswers, setExamResults }) {
    ...
    return <main className="flex flex-col items-center min-h-screen bg-stone-50 p-15 gap-10">
        ...
        <button disabled={grading} onClick={handleSubmit} className="cursor-pointer bg-blue-800 text-white py-3 px-9 rounded-xl hover:bg-blue-600 transition disabled:bg-gray-300 disabled:cursor-default">
